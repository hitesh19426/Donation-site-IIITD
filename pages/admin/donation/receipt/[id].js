...
function Receipt(donationData) {
    ...
    // const { name, email, phone, amount, category, razorpay_payment_id } = donationData;

    // // const donation = JSON.parse(JSON.stringify(donationData));
            ...
            <div style={{ marginBottom: "100px" }}>
                ...
                <div>
                    <h6 style={{
                        ...
                        IIIT-Delhi's Donation Receipt  </h6>
                </div>
